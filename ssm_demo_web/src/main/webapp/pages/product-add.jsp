        ...
        <form action="${pageContext.request.contextPath}/product/save.do" method="post">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control select2" name="cityName" style="width: 100%;">
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" name="departureTime" id="datepicker-a6">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control select2" name="productStatus" style="width: 100%;">
                    ...
                    <div class="col-md-10 data rowHeight2x">
                        <textarea class="form-control" rows="3" name="productDesc" placeholder="产品描述"></textarea>
                    </div>
